# Cloudflare Worker for embeddable code snippets
This doesn't get deployed to Vercel. This is a Cloudflare Worker that returns an embeddable JS script for code snippets.

```
<script src="usedevbook.com/c/[slug]"></script>
```
