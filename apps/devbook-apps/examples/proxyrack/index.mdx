...
<Output type="json" position={1} noContentLabel="Waiting for data" >
...
<Output type="json" position={2} expandPaths={['$','$.requestParams','$.requestParams.country']} noContentLabel="Waiting for /stats response">
`/stats` response
</Output>
</div>
